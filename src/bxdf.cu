...
__device__ Vec3 BxDFVariant::f(const Vec3& wo, const Vec3& wi) const {
  switch (which) {
  case 1:
	return lambert.f(wo, wi);
  case 2:
	return oren.f(wo, wi);
  case 3:
	return light.f(wo, wi);
  case 4:
	return microfacet.f(wo, wi);
  case 5:
	return reflect.f(wo, wi);
  case 6:
...
__device__ Vec3 BxDFVariant::sample_f(const Vec3& wo, Vec3* wi, float u, float v, int face, float* pdf) const {
  switch (which) {
  case 1:
	return lambert.sample_f(wo, wi, u, v, face, pdf);
  case 2:
	return oren.sample_f(wo, wi, u, v, face, pdf);
  case 3:
	return light.sample_f(wo, wi, u, v, face, pdf);
  case 4:
	return microfacet.sample_f(wo, wi, u, v, face, pdf);
  case 5:
	return reflect.sample_f(wo, wi, u, v, face, pdf);
  case 6:
	return specular.sample_f(wo, wi, u, v, face, pdf);
  }
  printf("Invalid selector %d!\n", which);
  *pdf = 0.f;
  return Vec3(1.f);
...
__device__ float BxDFVariant::pdf(const Vec3& wo, const Vec3& wi) const {
  ...
  case 2:
	return oren.pdf(wo, wi);
  case 3:
	return light.pdf(wo, wi);
  case 4:
	return microfacet.pdf(wo, wi);
  case 5:
	return reflect.pdf(wo, wi);
  case 6:
	return specular.pdf(wo, wi);
  }
  printf("Invalid selector %d!\n", which);
  return 0.f;
}
...
__host__ __device__ bool BxDFVariant::is_light() const {
  switch (which) {
  case 1:
	return lambert.is_light();
  case 2:
	return oren.is_light();
  case 3:
	return light.is_light();
  case 4:
	return microfacet.is_light();
  case 5:
	return reflect.is_light();
  case 6:
	return specular.is_light();
  }
  printf("Invalid selector %d!\n", which);
  return false;
}
...
__device__ Vec3 BxDFVariant::emittance() const {
  switch (which) {
  case 1:
	return lambert.emittance();
  case 2:
	return oren.emittance();
  case 3:
	return light.emittance();
  case 4:
	return microfacet.emittance();
  case 5:
	return reflect.emittance();
  case 6:
	return specular.emittance();
  }
  printf("Invalid selector %d!\n", which);
  return Vec3(0.f);
}
...
__device__ void BxDFVariant::tex_update(const Vector<Texture>& tex_arr, float u, float v) {
  switch (which) {
  case 1:
	return lambert.tex_update(tex_arr, u, v);
  case 2:
	return oren.tex_update(tex_arr, u, v);
  case 3:
	return light.tex_update(tex_arr, u, v);
  case 4:
	return microfacet.tex_update(tex_arr, u, v);
  case 5:
	return reflect.tex_update(tex_arr, u, v);
  case 6:
	return specular.tex_update(tex_arr, u, v);
  }
  printf("Invalid selector %d!\n", which);
}
